...
//	   Assert.assertEquals(totalSum, displayFormattedSum);
	   ...
	   //Hybrid - Google Page
	   Set<String> contexts = driver.getContextHandles();         //Collect all the contexts(native,webview)
	   for(String contextName : contexts)                         //enhanced loop
	   {
		   System.out.println(contextName);
	   }
	     driver.context("WEBVIEW_com.androidsample.generalstore");  //driver have knowledge on browser level  opening chrome driver
	     driver.findElement(By.name("q")).sendKeys("rahul shetty academy");
	     driver.findElement(By.name("q")).sendKeys(Keys.ENTER);
	     driver.pressKey(new KeyEvent(AndroidKey.BACK));
	     driver.context("NATIVE_APP");   //keywords
}}
