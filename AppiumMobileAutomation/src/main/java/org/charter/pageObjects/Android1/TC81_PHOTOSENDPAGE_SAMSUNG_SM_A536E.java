...
public class TC81_PHOTOSENDPAGE_SAMSUNG_SM_A536E extends AndroidActions {

	AndroidDriver driver;
	

	 public TC81_PHOTOSENDPAGE_SAMSUNG_SM_A536E(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
...
//		// driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(xpath(""));"));
//		 scrollToEndAction();
//		   }
