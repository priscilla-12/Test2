...
public class TC82_VIDEOSENDPAGE_SAMSUNG_SM_A536E extends AndroidActions {

	AndroidDriver driver;
	

	 public TC82_VIDEOSENDPAGE_SAMSUNG_SM_A536E(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
	 ...
	 //Resize
//	 @AndroidFindBy(id = "com.samsung.android.messaging:id/video_send_resize")
//	 private WebElement  selectVideoSize;
