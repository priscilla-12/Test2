...
public class SearchContactPage extends AndroidActions {

	AndroidDriver driver;

	public SearchContactPage(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void contact() throws InterruptedException {
		...
		if (contactcount > 0) {
			...
			System.out.println(
					"Length of the result showing element , verifyContacts is 9 and the actual result is, " + contact);
		} else {
